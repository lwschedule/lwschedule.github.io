...
Current special schedules: `first-week`, `labor-day`, `homecoming`, `veterans-day`, plus `last-week` and `moving-up` (each has a page under `/schedules/`).
...
|---|---|---|
| `normal`, `first-week`, `veterans-day` | Mon, Tue, Thu | Fri |
