...
Current special schedules: `first-week`, `labor-day`, `homecoming`, `veterans-day`, `thanksgiving`, `mlk-day`, plus `last-week` and `moving-up` (each has a page under `/schedules/`).
